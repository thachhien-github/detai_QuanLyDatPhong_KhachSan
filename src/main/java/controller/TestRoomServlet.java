...
@WebServlet(name = "TestRoomServlet", urlPatterns = {"/test"})
public class TestRoomServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<style>body{font-family:Arial, Helvetica, sans-serif;padding:20px;} "
            ...
            try {
                ...
                if (rooms != null && !rooms.isEmpty()) {
                    ...
                    for (Room r : rooms) {
                        out.println("<tr>"
                                + "<td>" + escapeHtml(r.getMaPhong()) + "</td>"
                                + "<td>" + escapeHtml(r.getMaLoaiPhong()) + "</td>"
